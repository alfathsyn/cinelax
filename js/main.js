...
const heroSlides = [
  {
    ...
    originalTitle: 'Avatar 3: Fire and Ash (2025)',
    year: 2025,
    rating: '9.2',
    duration: '3h 15m',
    quality: '4K Ultra HD',
    ...
    description: 'Jake Sully dan Neytiri menghadapi ancaman suku Na\'vi baru yang kejam dan mematikan di Pandora: Suku Abu (Ash People) yang tinggal di wilayah vulkanik, membawa konflik peradaban Pandora ke tingkat kehancuran total.',
    poster: 'assets/posters/avatar-fire-and-ash-2025.jpg',
    backdrop: 'assets/hero/hero-avatar.jpg',
    gradient: 'linear-gradient(135deg, #ff416c 0%, #ff4b2b 50%, #1a002e 100%)',
    emoji: '🔥',
    badge: '👑 Top View #1 — Rilis 2025',
    slug: 'avatar-fire-and-ash-2025',
    imdbId: 'tt1757678',
    tmdbId: '83533',
    idlixUrl: 'https://z2.idlixku.com/movie/avatar-fire-and-ash-2025/',
    isUnavailable: true,
  ...
  },
  {
    id: 'superman-2025',
    title: 'Superman',
    originalTitle: 'Superman: Legacy (2025)',
    year: 2025,
    rating: '9.0',
    duration: '2h 25m',
    quality: '4K Ultra HD',
    ...
    description: 'Awal era baru DC Universe (DCU). Clark Kent menyeimbangkan warisan Krypton-nya dengan asuhan manusianya di Smallville, menjadi simbol kebenaran, keadilan, dan kemanusiaan di dunia yang kehilangan arah.',
    poster: 'assets/posters/superman-2025.jpg',
    backdrop: 'assets/hero/hero-superman.jpg',
    gradient: 'linear-gradient(135deg, #000428 0%, #004e92 50%, #e50914 100%)',
    emoji: '🦸',
    badge: '⭐ Blockbuster 2025',
    slug: 'superman-2025',
    imdbId: 'tt5950044',
    tmdbId: '1064213',
    idlixUrl: 'https://z2.idlixku.com/movie/superman-2025/',
    isUnavailable: true,
  ...
  },
  {
    ...
    type: 'movie',
    genre: 'Action',
    genres: ['Action', 'Sci-Fi', 'Superhero', 'Adventure'],
    country: 'United States',
    director: 'Anthony & Joe Russo',
    cast: 'Robert Downey Jr. (Doctor Doom), Pedro Pascal, Benedict Cumberbatch, Chris Hemsworth',
    description: 'Victor von Doom bangkit sebagai ancaman multiversal paling berbahaya di Marvel Cinematic Universe. Para pahlawan terkuat dari berbagai dimensi harus bersatu sebelum Doom mengambil kendali seluruh garis waktu.',
    poster: 'assets/posters/avengers-doomsday-2026.jpg',
    backdrop: 'assets/hero/hero-avengers.jpg',
    gradient: 'linear-gradient(135deg, #11998e 0%, #38ef7d 50%, #200122 100%)',
    emoji: '👑',
    badge: '🚀 Most Anticipated 2026',
    slug: 'avengers-doomsday-2026',
    imdbId: 'tt21361450',
    tmdbId: '1003596',
    idlixUrl: 'https://z2.idlixku.com/movie/avengers-doomsday-2026/',
    isUnavailable: true,
...
const TOP_VIEW_DATABASE = {
  topview: [
    { title: 'Avatar: Fire and Ash', year: 2025, rating: '9.2', genre: 'Sci-Fi', quality: '4K', type: 'movie', country: 'United States', imdbId: 'tt1757678', tmdbId: '83533', emoji: '🔥', director: 'James Cameron', cast: 'Sam Worthington, Zoe Saldana', desc: 'Pertempuran baru di Pandora melawan klan api yang kejam.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/d9MyW72ELq0' },
    { title: 'Superman', year: 2025, rating: '9.0', genre: 'Superhero', quality: '4K', type: 'movie', country: 'United States', imdbId: 'tt5950044', tmdbId: '1064213', emoji: '🦸', director: 'James Gunn', cast: 'David Corenswet, Rachel Brosnahan', desc: 'Awal baru pelindung bumi dari Metropolis di semesta DCU.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/uhUht6vAsMY' },
    { title: 'Avengers: Doomsday', year: 2026, rating: '9.5', genre: 'Action', quality: '4K', type: 'movie', country: 'United States', imdbId: 'tt21361450', tmdbId: '1003596', emoji: '👑', director: 'Russo Brothers', cast: 'Robert Downey Jr., Pedro Pascal', desc: 'Doctor Doom mengancam keselamatan seluruh multisemesta Marvel.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/6ZfuNTqbHE8' },
    ...
    { title: 'The Batman: Part II', year: 2026, rating: '9.1', genre: 'Crime', quality: '4K', type: 'movie', country: 'United States', imdbId: 'tt20245388', tmdbId: '414906', emoji: '🦇', director: 'Matt Reeves', cast: 'Robert Pattinson, Colin Farrell', desc: 'Gotham City tenggelam dalam konspirasi baru pasca banjir besar.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/mqqft2x_Aa4' },
    { title: 'Spider-Man: Beyond the Spider-Verse', year: 2026, rating: '9.2', genre: 'Animation', quality: '1080p', type: 'movie', country: 'United States', imdbId: 'tt9362722', tmdbId: '569094', emoji: '🕷️', director: 'Joaquim Dos Santos', cast: 'Shameik Moore, Hailee Steinfeld', desc: 'Miles Morales melawan takdir kanon di seluruh multiverse Spider.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/shW9i6k8cB0' },
    { title: 'Jurassic World Rebirth', year: 2025, rating: '8.7', genre: 'Adventure', quality: '1080p', type: 'movie', country: 'United States', imdbId: 'tt31036940', tmdbId: '1196470', emoji: '🦖', director: 'Gareth Edwards', cast: 'Scarlett Johansson, Jonathan Bailey', desc: 'Ekspedisi rahasia ke zona ekuator untuk mengamankan DNA dinosaurus purba.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/aDmsGkPao-4' },
    { title: 'Mickey 17', year: 2025, rating: '8.8', genre: 'Sci-Fi', quality: '1080p', type: 'movie', country: 'United States', imdbId: 'tt11358390', tmdbId: '939243', emoji: '🚀', director: 'Bong Joon-ho', cast: 'Robert Pattinson, Steven Yeun', desc: 'Kloning manusia yang dikirim ke planet es menolak untuk mati.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/osYpGSz_9Do' },
    { title: 'Fantastic Four: First Steps', year: 2025, rating: '8.9', genre: 'Action', quality: '4K', type: 'movie', country: 'United States', imdbId: 'tt10676052', tmdbId: '617126', emoji: '🌌', director: 'Matt Shakman', cast: 'Pedro Pascal, Vanessa Kirby', desc: 'Keluarga pertama Marvel menghadapi ancaman kosmik Galactus.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/1v0Uj_8cO3w' },
    ...
    { title: 'Ballerina (John Wick Universe)', year: 2025, rating: '8.7', genre: 'Action', quality: '1080p', type: 'movie', country: 'United States', imdbId: 'tt7164472', tmdbId: '541134', emoji: '🩰', director: 'Len Wiseman', cast: 'Ana de Armas, Keanu Reeves', desc: 'Pembunuh bayaran wanita memburu pelaku pembantaian keluarganya.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/0n2Z4V283oE' },
    { title: '28 Years Later', year: 2025, rating: '8.8', genre: 'Horror', quality: '1080p', type: 'movie', country: 'United Kingdom', imdbId: 'tt31005230', tmdbId: '1228404', emoji: '🧟', director: 'Danny Boyle', cast: 'Cillian Murphy, Aaron Taylor-Johnson', desc: 'Virus Rage kembali bermutasi 28 tahun kemudian di daratan Inggris.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/G4VmJ9oEQr0' },
    { title: 'Tron: Ares', year: 2025, rating: '8.5', genre: 'Sci-Fi', quality: '1080p', type: 'movie', country: 'United States', imdbId: 'tt6604188', tmdbId: '505600', emoji: '🤖', director: 'Joachim Rønning', cast: 'Jared Leto, Evan Peters', desc: 'Program digital cerdas Ares melintasi batas ke dunia nyata manusia.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/N0vK_iH6Wz8' }
  ],
  ...
  trending: [
    ...
    { title: 'Godzilla x Kong: Supernova', year: 2026, rating: '8.7', genre: 'Action', quality: '4K', type: 'movie', country: 'United States', imdbId: 'tt29341490', tmdbId: '1004123', emoji: '🦍', director: 'Grant Sputore', cast: 'Dan Stevens, Rebecca Hall', desc: 'Dua raja monster Titan bersekutu melawan entitas purba dari inti Hollow Earth.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/qqrpMRDuPfc' },
    { title: 'Shrek 5', year: 2026, rating: '8.8', genre: 'Animation', quality: '1080p', type: 'movie', country: 'United States', imdbId: 'tt10676058', tmdbId: '809', emoji: '🧅', director: 'Walt Dohrn', cast: 'Mike Myers, Eddie Murphy, Cameron Diaz', desc: 'Kembalinya ogre hijau legendaris dan keledai cerewet di Kerajaan Far Far Away.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/6r_qJ4n33nU' }
  ],

  latest: [
    { title: 'Superman', year: 2025, rating: '9.0', genre: 'Superhero', quality: '4K', type: 'movie', country: 'United States', imdbId: 'tt5950044', tmdbId: '1064213', emoji: '🦸', director: 'James Gunn', cast: 'David Corenswet, Rachel Brosnahan', desc: 'Awal baru pahlawan legendaris Krypton di DCU.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/uhUht6vAsMY' },
    { title: 'Avatar: Fire and Ash', year: 2025, rating: '9.2', genre: 'Sci-Fi', quality: '4K', type: 'movie', country: 'United States', imdbId: 'tt1757678', tmdbId: '83533', emoji: '🔥', director: 'James Cameron', cast: 'Sam Worthington, Zoe Saldana', desc: 'Klan api Pandora mengancam keharmonisan alam semesta.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/d9MyW72ELq0' },
    { title: 'Avengers: Doomsday', year: 2026, rating: '9.5', genre: 'Action', quality: '4K', type: 'movie', country: 'United States', imdbId: 'tt21361450', tmdbId: '1003596', emoji: '👑', director: 'Russo Brothers', cast: 'Robert Downey Jr., Pedro Pascal', desc: 'Doctor Doom membawa ancaman kehancuran total MCU.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/6ZfuNTqbHE8' },
    { title: 'Spider-Man: Beyond the Spider-Verse', year: 2026, rating: '9.2', genre: 'Animation', quality: '1080p', type: 'movie', country: 'United States', imdbId: 'tt9362722', tmdbId: '569094', emoji: '🕷️', director: 'Joaquim Dos Santos', cast: 'Shameik Moore, Hailee Steinfeld', desc: 'Babak penutup perjalanan Miles Morales melintasi dimensi.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/shW9i6k8cB0' },
    { title: 'Mickey 17', year: 2025, rating: '8.8', genre: 'Sci-Fi', quality: '1080p', type: 'movie', country: 'United States', imdbId: 'tt11358390', tmdbId: '939243', emoji: '🚀', director: 'Bong Joon-ho', cast: 'Robert Pattinson, Steven Yeun', desc: 'Klon ekspedisi manusia menolak mati di planet es Niflheim.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/osYpGSz_9Do' },
    { title: 'Jurassic World Rebirth', year: 2025, rating: '8.7', genre: 'Adventure', quality: '1080p', type: 'movie', country: 'United States', imdbId: 'tt31036940', tmdbId: '1196470', emoji: '🦖', director: 'Gareth Edwards', cast: 'Scarlett Johansson, Jonathan Bailey', desc: 'Misi berbahaya mengamankan genetika reptil raksasa.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/aDmsGkPao-4' },
    { title: 'The Batman: Part II', year: 2026, rating: '9.1', genre: 'Crime', quality: '4K', type: 'movie', country: 'United States', imdbId: 'tt20245388', tmdbId: '414906', emoji: '🦇', director: 'Matt Reeves', cast: 'Robert Pattinson, Colin Farrell', desc: 'Pembalasan dendam kegelapan di sudut kota Gotham.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/mqqft2x_Aa4' },
    ...
    { title: 'Fantastic Four: First Steps', year: 2025, rating: '8.9', genre: 'Action', quality: '4K', type: 'movie', country: 'United States', imdbId: 'tt10676052', tmdbId: '617126', emoji: '🌌', director: 'Matt Shakman', cast: 'Pedro Pascal, Vanessa Kirby', desc: 'Pahlawan retro-futuristik Marvel menghadapi entitas Galactus.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/1v0Uj_8cO3w' },
    { title: 'Ballerina', year: 2025, rating: '8.7', genre: 'Action', quality: '1080p', type: 'movie', country: 'United States', imdbId: 'tt7164472', tmdbId: '541134', emoji: '🩰', director: 'Len Wiseman', cast: 'Ana de Armas, Keanu Reeves', desc: 'Aksi balas dendam pembunuh balerina Ruska Roma.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/0n2Z4V283oE' },
    { title: '28 Years Later', year: 2025, rating: '8.8', genre: 'Horror', quality: '1080p', type: 'movie', country: 'United Kingdom', imdbId: 'tt31005230', tmdbId: '1228404', emoji: '🧟', director: 'Danny Boyle', cast: 'Cillian Murphy, Aaron Taylor-Johnson', desc: 'Wabah infeksi kemarahan bangkit kembali di era modern.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/G4VmJ9oEQr0' },
    { title: 'Tron: Ares', year: 2025, rating: '8.5', genre: 'Sci-Fi', quality: '1080p', type: 'movie', country: 'United States', imdbId: 'tt6604188', tmdbId: '505600', emoji: '🤖', director: 'Joachim Rønning', cast: 'Jared Leto, Evan Peters', desc: 'Kecerdasan AI Ares menyusup ke dunia manusia.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/N0vK_iH6Wz8' },
    { title: 'Toy Story 5', year: 2026, rating: '8.9', genre: 'Animation', quality: '1080p', type: 'movie', country: 'United States', imdbId: 'tt10676060', tmdbId: '810', emoji: '🤠', director: 'Andrew Stanton', cast: 'Tom Hanks, Tim Allen', desc: 'Woody dan Buzz menghadapi ancaman era mainan elektronik pintar.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/wmiIUN-7qhE' },
  ...
  popular: [
    { title: 'Avatar: Fire and Ash', year: 2025, rating: '9.2', genre: 'Sci-Fi', quality: '4K', type: 'movie', country: 'United States', imdbId: 'tt1757678', tmdbId: '83533', emoji: '🔥', director: 'James Cameron', cast: 'Sam Worthington, Zoe Saldana', desc: 'Film paling dinanti abad ini dengan visual spektakuler Pandora.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/d9MyW72ELq0' },
    ...
    { title: 'Avengers: Doomsday', year: 2026, rating: '9.5', genre: 'Action', quality: '4K', type: 'movie', country: 'United States', imdbId: 'tt21361450', tmdbId: '1003596', emoji: '👑', director: 'Russo Brothers', cast: 'Robert Downey Jr., Pedro Pascal', desc: 'Reuni terbesar seluruh pahlawan Marvel melawan Doctor Doom.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/6ZfuNTqbHE8' },
    ...
    { title: 'Superman', year: 2025, rating: '9.0', genre: 'Superhero', quality: '4K', type: 'movie', country: 'United States', imdbId: 'tt5950044', tmdbId: '1064213', emoji: '🦸', director: 'James Gunn', cast: 'David Corenswet, Rachel Brosnahan', desc: 'Kelahiran kembali pahlawan harapan manusia di DC Studios.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/uhUht6vAsMY' },
    { title: 'The Batman: Part II', year: 2026, rating: '9.1', genre: 'Crime', quality: '4K', type: 'movie', country: 'United States', imdbId: 'tt20245388', tmdbId: '414906', emoji: '🦇', director: 'Matt Reeves', cast: 'Robert Pattinson, Colin Farrell', desc: 'Detektif terhebat di dunia mengungkap jaringan kriminal Penguin.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/mqqft2x_Aa4' },
    { title: 'Spider-Man: Beyond the Spider-Verse', year: 2026, rating: '9.2', genre: 'Animation', quality: '1080p', type: 'movie', country: 'United States', imdbId: 'tt9362722', tmdbId: '569094', emoji: '🕷️', director: 'Joaquim Dos Santos', cast: 'Shameik Moore, Hailee Steinfeld', desc: 'Revolusi animasi seni dan cerita Spider-Man terbaik.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/shW9i6k8cB0' },
    { title: 'Godzilla x Kong: Supernova', year: 2026, rating: '8.7', genre: 'Action', quality: '4K', type: 'movie', country: 'United States', imdbId: 'tt29341490', tmdbId: '1004123', emoji: '🦍', director: 'Grant Sputore', cast: 'Dan Stevens, Rebecca Hall', desc: 'Raksasa purba bertarung di permukaan dan kedalaman bumi.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/qqrpMRDuPfc' }
  ],
  ...
  series: [
    ...
    { title: 'House of the Dragon Season 3', year: 2026, rating: '9.0', genre: 'Fantasy', quality: '4K', type: 'series', country: 'United States', imdbId: 'tt11198330', tmdbId: '94997', emoji: '🐉', director: 'Ryan Condal', cast: 'Emma D\'Arcy, Matt Smith, Olivia Cooke', episodeCount: 8, desc: 'Perang saudara naga klan Targaryen memuncak dalam pertumpahan darah.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/DotnJ7tTA34' },
  ...
  indonesia: [
    { title: 'Pengabdi Setan 3: Babak Terakhir', year: 2025, rating: '8.8', genre: 'Horror', quality: '1080p', type: 'movie', country: 'Indonesia', imdbId: 'tt12349001', tmdbId: '7001', emoji: '🔔', director: 'Joko Anwar', cast: 'Tara Basro, Endy Arfian, Bront Palarae', desc: 'Penutup trilogi teror sekte penyembah setan dan misteri Ibu di rusun tua.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/0hB3tdkF_9E' },
    { title: 'Siksa Kubur 2: Alam Barzakh', year: 2025, rating: '8.7', genre: 'Horror', quality: '1080p', type: 'movie', country: 'Indonesia', imdbId: 'tt12349002', tmdbId: '7002', emoji: '💀', director: 'Joko Anwar', cast: 'Reza Rahadian, Faradina Mufti, Christine Hakim', desc: 'Pembuktian mengerikan tentang dosa, siksa alam kubur, dan hisab akhirat.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/g_pBwXGz6B0' },
    { title: 'KKN di Desa Penari: Sengarturih 2', year: 2025, rating: '8.5', genre: 'Horror', quality: '1080p', type: 'movie', country: 'Indonesia', imdbId: 'tt12349003', tmdbId: '7003', emoji: '🐍', director: 'Awi Suryadi', cast: 'Tissa Biani, Adinda Thomas', desc: 'Kutukan tari siluman ular Badarawuhi di hutan terlarang Jawa Timur.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/oZ4l0r5f9y4' },
    { title: 'Gundala: Putra Petir Returns', year: 2026, rating: '8.9', genre: 'Superhero', quality: '4K', type: 'movie', country: 'Indonesia', imdbId: 'tt12349004', tmdbId: '7004', emoji: '⚡', director: 'Joko Anwar', cast: 'Abimana Aryasatya, Tara Basro, Muzakki Ramdhan', desc: 'Sancaka menghadapi bangkitnya Ki Wilawuk dan ancaman kehancuran Jagat Bumilangit.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/tS0yq4F6F4c' },
    { title: 'Sri Asih 2: Kebangkitan Dewi Api', year: 2026, rating: '8.8', genre: 'Superhero', quality: '4K', type: 'movie', country: 'Indonesia', imdbId: 'tt12349005', tmdbId: '7005', emoji: '🔥', director: 'Upi', cast: 'Pevita Pearce, Reza Rahadian, Jefri Nichol', desc: 'Alana menghadapi titisan Dewi Api yang ingin membakar seluruh negeri.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/8w40q3rKq_E' },
    ...
    { title: 'Dilan 2026: Ancika Selamanya', year: 2026, rating: '8.6', genre: 'Romance', quality: '1080p', type: 'movie', country: 'Indonesia', imdbId: 'tt12349007', tmdbId: '7007', emoji: '🛵', director: 'Benni Setiawan', cast: 'Arbani Yasiz, Zee JKT48', desc: 'Kisah cinta manis dan penuh kenangan Dilan di masa kuliah bersama Ancika.', unavailable: true, trailerUrl: 'https://www.youtube-nocookie.com/embed/XqC9hI4fP6A' },
